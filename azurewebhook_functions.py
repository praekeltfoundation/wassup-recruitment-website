    ...
    def create_rapidpro_contact(self,name, phone, registration_number):
        ...
        try:
            ...
            if(existing_contacts == 0):
                ...
                contact = client.update_contact(contact = phone,
                                                name = name,
                                                groups =['Smoking Cessation'],
                                                fields=fields)
            flow_start = client.create_flow_start('df1e0286-55d5-464c-bae1-3d1cf3c8dd67', urns=[phone], restart_participants=True, extra=None)
            print(flow_start)
        except:
